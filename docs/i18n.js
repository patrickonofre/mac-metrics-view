...
(function () {
  ...
  var STRINGS = {
    pt: {
      ...
      "hero.eyebrow": "Versão 1.1 para macOS",
      ...
      "download.title": "Baixe a versão 1.1.",
      "download.body": "Versão 1.1 para macOS (Apple Silicon). Na primeira abertura, o macOS pode pedir confirmação por ser um app ainda não notarizado — depois disso, o app se mantém atualizado sozinho.",
      "download.cta": "Baixar MacMetricsView-1.1.0.zip",
      ...
      "footer.tagline": "Versão 1.1 para macOS"
    },
    en: {
      "nav.news": "What's new",
      ...
      "hero.eyebrow": "Version 1.1 for macOS",
      ...
      "download.eyebrow": "Download",
      "download.title": "Download version 1.1.",
      "download.body": "Version 1.1 for macOS (Apple Silicon). On first launch, macOS may ask for confirmation because the app is not yet notarized — after that, the app keeps itself up to date.",
      "download.cta": "Download MacMetricsView-1.1.0.zip",
      ...
      "footer.tagline": "Version 1.1 for macOS"
    }
  };
