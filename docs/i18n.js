...
(function () {
  ...
  var STRINGS = {
    pt: {
      ...
      "sticky.label": "Código aberto no GitHub",
      "sticky.cta": "Repositório",
      ...
      "repo.eyebrow": "Repositório",
      "repo.title": "Código, releases e histórico no GitHub.",
      "repo.body": "O site não oferece mais download direto. Use o repositório para ver o código, acompanhar releases e compilar o app localmente.",
      "repo.cta": "Abrir repositório",
      "repo.meta": "macOS 14+ · Apple Silicon · código aberto · Licença MIT",
    ...
    en: {
      ...
      "sticky.label": "Open source on GitHub",
      "sticky.cta": "Repository",
      ...
      "repo.title": "Code, releases, and history on GitHub.",
      "repo.body": "The site no longer offers direct downloads. Use the repository to view the code, follow releases, and build the app locally.",
      "repo.cta": "Open repository",
      "repo.meta": "macOS 14+ · Apple Silicon · open source · MIT License",
  ...
  // Which language this URL represents. The English page lives at /en/; every
  // other path is the Portuguese default. Each language is a real, separately
  // crawlable page (index.html vs en/index.html), so the language switch below
  // is plain navigation — not an in-place swap — keeping one URL per language.
  function pathLang() {
  ...
  function init() {
    ...
    // Relative hops between the two pages: PT at the root, EN one level down.
